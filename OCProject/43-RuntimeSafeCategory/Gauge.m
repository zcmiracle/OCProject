...
- (void)fl_drawProgressLayer {
    ...
    UIBezierPath *progressPath =  [UIBezierPath bezierPathWithArcCenter:center radius:self.cornerRadius startAngle:M_PI / 180 * 142 endAngle: M_PI / 180 * 245 clockwise:YES];
    ...
    UIBezierPath *progressPath2 = [UIBezierPath bezierPathWithArcCenter:center radius:self.cornerRadius startAngle:M_PI / 180 * 273 endAngle: M_PI / 180 * 398 clockwise:YES];
